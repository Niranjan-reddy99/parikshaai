          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: 14, padding: '20px 24px' }}>
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                {[
                  {
                    id: 'whatsapp', label: 'WhatsApp', color: '#16a34a', bg: 'rgba(22,163,74,0.12)',
                    icon: (
                  ...
                  {
                    id: 'telegram', label: 'Telegram', color: '#0369a1', bg: 'rgba(3,105,161,0.12)',
                    icon: (
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  {
                    id: 'twitter', label: 'Twitter / X', color: 'var(--text)', bg: 'var(--bg-alt)',
                    icon: (
                ...
                {STEPS.map((step, i) => (
                  <div key={i} style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
                    <div style={{
                      ...
                      background: i === 0 ? 'var(--blue-soft)' : i === 1 ? 'rgba(124,58,237,0.12)' : 'var(--green-soft)',
                      color: i === 0 ? 'var(--blue)' : i === 1 ? '#7c3aed' : 'var(--green)',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14, position: 'sticky', top: 24 }}>
            ...
            <div style={{ background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: 14, padding: '18px 20px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                <div style={{ padding: '12px 14px', background: 'var(--green-soft)', border: '1px solid rgba(16,185,129,0.25)', borderRadius: 10 }}>
                  <div style={{ fontSize: 12, fontWeight: 700, color: 'var(--green)', marginBottom: 3 }}>You (referrer)</div>
                ...
                <div style={{ padding: '12px 14px', background: 'var(--blue-soft)', border: '1px solid rgba(37,99,235,0.25)', borderRadius: 10 }}>
                  <div style={{ fontSize: 12, fontWeight: 700, color: 'var(--blue)', marginBottom: 3 }}>Your friend</div>
                  <div style={{ fontSize: 12.5, color: 'var(--text-sec)', lineHeight: 1.5 }}>
          ...
          <div style={{ background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: 14, padding: '22px 24px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {MILESTONES.map(({ count, reward }, i) => {
                ...
                const bgs = ['rgba(220,38,38,0.1)', 'var(--warn-soft)', 'var(--green-soft)', 'var(--blue-soft)', 'rgba(124,58,237,0.1)'];
                const borderColors = ['rgba(220,38,38,0.25)', 'rgba(217,119,6,0.25)', 'rgba(16,185,129,0.25)', 'rgba(37,99,235,0.25)', 'rgba(124,58,237,0.25)'];
                return (
                  <div
                    key={count}
                    style={{
            ...
            <div style={{ marginTop: 18, padding: '14px 16px', background: 'var(--blue-soft)', border: '1px solid rgba(37,99,235,0.25)', borderRadius: 10, fontSize: 12.5, color: 'var(--blue)', lineHeight: 1.6 }}>
